...
00008620             fac:
00008620             .text:
00008620       31f7           STW.D2T2      B3,*B15--[2]
00008622       ac45           STW.D2T1      A4,*B15[1]
00008624   00101fda           MV.L2X        A4,B0
00008628   2008a120    [ B0]  BNOP.S1       $C$L1 (PC+16 = 0x00008630),5
0000862c       840a           BNOP.S1       $C$L2 (PC+32 = 0x00008640),4
0000862e       2626           MVK.L1        1,A4
00008630             $C$L1:
00008630       001b           CALLP.S2      fac (PC+0 = 0x00008620),B3
00008632       fc40 ||        ADD.L1X       B0,-1,A4
00008634             $C$RL0:
00008634       bc4d           LDW.D2T2      *B15[1],B4
00008636       6c6e           NOP           4
00008638   02109800           MPY32.M1X     A4,B4,A4
0000863c   e7208100           .fphead       n, l, W, BU, br, nosat, 0111001b
00008640             $C$L2:
00008640       71f7           LDW.D2T2      *++B15[2],B3
00008642       6c6e           NOP           4
00008644   008ca362           BNOP.S2       B3,5
00008648             main:
00008648   01bc94f6           STW.D2T2      B3,*B15--[4]
0000864c       05a6           MVK.L1        0,A3
0000864e       cc35           STW.D2T1      A3,*B15[2]
00008650       a627           MVK.L2        5,B4
00008652       fc45           STW.D2T2      B4,*B15[3]
00008654       91c7           MV.L2X        A3,B4
00008656       bc45           STW.D2T2      B4,*B15[1]
00008658       fc4d           LDW.D2T2      *B15[3],B4
0000865a       b1c7           MV.L2X        A3,B5
0000865c   ef200000           .fphead       n, l, W, BU, nobr, nosat, 1111001b
00008660       4c6e           NOP           3
00008662       9d89           CMPLT.L2X     B4,A3,B0
00008664   2016a120    [ B0]  BNOP.S1       $C$DW$L$main$2$E (PC+44 = 0x0000868c),5
00008668             $C$L3:
00008668             $C$DW$L$main$2$B:
00008668       fc1b           CALLP.S2      fac (PC-64 = 0x00008620),B3
0000866a       92c6 ||        MV.L1X        B5,A4
0000866c             $C$RL1:
0000866c       dc4d           LDW.D2T2      *B15[2],B4
0000866e       6c6e           NOP           4
00008670       9241           ADD.L2X       B4,A4,B4
00008672       dc45           STW.D2T2      B4,*B15[2]
00008674       bc4d           LDW.D2T2      *B15[1],B4
00008676       6c6e           NOP           4
00008678       2641           ADD.L2        B4,1,B4
0000867a       bc45           STW.D2T2      B4,*B15[1]
0000867c   efa08010           .fphead       n, l, W, BU, br, nosat, 1111101b
00008680       fc4d           LDW.D2T2      *B15[3],B4
00008682       bc5d           LDW.D2T2      *B15[1],B5
00008684       6c6e           NOP           4
00008686       ae29           CMPGT.L2      B5,B4,B0
00008688   3ff4a120    [!B0]  BNOP.S1       $C$L3 (PC-24 = 0x00008668),5
0000868c             $C$DW$L$main$2$E:
0000868c             $C$L4:
0000868c       cc4d           LDW.D2T1      *B15[2],A4
0000868e       6c6e           NOP           4
00008690   01bc92e6           LDW.D2T2      *++B15[4],B3
00008694       6c6e           NOP           4
00008696       a1ef           BNOP.S2       B3,5
00008698   00000000           NOP           
0000869c   e5600000           .fphead       n, l, W, BU, nobr, nosat, 0101011b
...
00008708   02c3242a ||        MVK.S2        0xffff8648,B5
