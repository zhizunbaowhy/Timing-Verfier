...
TEXT Section .text (Little Endian), 0x880 bytes at 0x8000 
...
00008198   c3465628 || [ A0]  MVK.S1        0xffff8cac,A6
0000819c   e1400088           .fphead       n, l, W, BU, nobr, nosat, 0001010b
000081a0   d0001c11    [!A0]  B.S1          copy_in (PC+224 = 0x00008280)
000081a4   c246622a || [ A0]  MVK.S2        0xffff8cc4,B4
000081a8   c2c6502b    [ A0]  MVK.S2        0xffff8ca0,B5
000081ac   c1c65a28 || [ A0]  MVK.S1        0xffff8cb4,A3
...
000081c4             $C$RL0:
000081c4   03465629           MVK.S1        0xffff8cac,A6
000081c8   02c6502a ||        MVK.S2        0xffff8ca0,B5
000081cc   01c65a29           MVK.S1        0xffff8cb4,A3
000081d0   0246622a ||        MVK.S2        0xffff8cc4,B4
...
0000825c   1000a812           CALLP.S2      __TI_cpp_init (PC+1344 = 0x00008780),B3
...
000082b8   92c65029    [!A1]  MVK.S1        0xffff8ca0,A5
...
000082e4   83465028 || [ A1]  MVK.S1        0xffff8ca0,A6
...
00008380             __TI_zero_init:
00008380             .text:decompress:ZI:__TI_zero_init:
00008380       6630           ADD.L1        A4,3,A3
00008382       0212 ||        MVK.S1        0,A4
00008384   029000db ||        NEG.L2        B4,B5
00008388       1656 ||        MV.D1X        B4,A8
0000838a       05a6           MVK.L1        0,A3
0000838c   0294ef5b ||        AND.L2        7,B5,B5
00008390   000c0264 ||        LDW.D1T1      *+A3[0],A0
00008394   03106d18           PACKL4.L1     A3,A4,A6
00008398   00942f5a           AND.L2        1,B5,B1
0000839c   e0a00023           .fphead       n, l, W, BU, nobr, nosat, 0000101b
000083a0       a346           MV.L1         A6,A5
000083a2       8346           MV.L1         A6,A4
000083a4       bc49           CMPLTU.L2X    B5,A0,B0
000083a6       c8e7    [!B0]  MVK.L2        0,B1
000083a8   201410f9 || [ B0]  SUB.L1X       A0,B5,A0
000083ac   211447a3 || [ B0]  AND.S2        2,B5,B2
000083b0       c977 || [!B0]  MVK.D2        0,B2
000083b2       8b67    [ B0]  MVK.L2        0,B6
000083b4   44103059 || [ B1]  ADD.L1X       1,B4,A8
000083b8   048089a0 ||        SHRU.S1       A0,0x4,A9
000083bc   e2600208           .fphead       n, l, W, BU, nobr, nosat, 0010011b
000083c0   431002b7    [ B1]  STB.D2T2      B6,*+B4[0]
000083c4   63203655 || [ B2]  STH.D1T1      A6,*A8++[1]
000083c8   211487a3 || [ B0]  AND.S2        4,B5,B2
000083cc   03a48ca1 ||        SHL.S1        A9,0x4,A7
000083d0       f047 ||        MV.L2X        A0,B7
000083d2       4be7    [!A0]  MVK.L2        0,B7
000083d4   0001ebd9 ||        CMPLTU.L1     0xf,A0,A0
000083d8   310c16a2 || [!B0]  MV.S2X        A3,B2
000083dc   e2000200           .fphead       n, l, W, BU, nobr, nosat, 0010000b
000083e0   d0174121    [!A0]  BNOP.S1       $C$L4 (PC+46 = 0x0000840e),2
000083e4   c6a413a3 || [ A0]  MVC.S2X       A9,ILC
000083e8   63203674 || [ B2]  STW.D1T1      A6,*A8++[1]
000083ec   c2101fda    [ A0]  MV.L2X        A4,B4
000083f0   01a10058           ADD.L1        8,A8,A3
000083f4   c2941fda    [ A0]  MV.L2X        A5,B5
000083f8       0c66           SPLOOP        1
000083fa       d407 ||        MV.L2X        A8,B6
000083fc   e8001000           .fphead       n, l, W, BU, nobr, nosat, 1000000b
00008400       2ce6           SPMASK        L2
00008402       fbf1 ||^       SUB.L2X       B7,A7,B7
00008404   020c5745 ||        STDW.D1T1     A5:A4,*A3++[2]
00008408       3d45 ||        STDW.D2T2     B5:B4,*B6++[2]
0000840a       1c67           SPKERNEL      1,0
0000840c       1746           MV.L1X        B6,A8
0000840e             $C$L4:
0000840e       01ef           BNOP.S2       B3,0
00008410   001d0f5a ||        AND.L2        8,B7,B0
00008414   001c8f5b           AND.L2        4,B7,B0
00008418   24210059 || [ B0]  ADD.L1        8,A8,A8
0000841c   e1a40083           .fphead       n, l, DW/NDW, W, nobr, nosat, 0001101b
00008420   22a00374 || [ B0]  STNDW.D1T1    A5:A4,*+A8[0]
00008424   001c4f5b           AND.L2        2,B7,B0
00008428   24208059 || [ B0]  ADD.L1        4,A8,A8
0000842c   23200355 || [ B0]  STNW.D1T1     A6,*+A8[0]
00008430   01800028 ||        MVK.S1        0x0000,A3
00008434   21a00234    [ B0]  STB.D1T1      A3,*+A8[0]
00008438   001c2f5b           AND.L2        1,B7,B0
0000843c   24204059 || [ B0]  ADD.L1        2,A8,A8
00008440   21a02234 || [ B0]  STB.D1T1      A3,*+A8[1]
00008444   21a00234    [ B0]  STB.D1T1      A3,*+A8[0]
...
00008460             exit:
00008460             .text:exit:
00008460   01c64429           MVK.S1        0xffff8c88,A3
...
00008488   21c64229    [ B0]  MVK.S1        0xffff8c84,A3
...
000084ac             $C$RL0:
000084ac   01c64228           MVK.S1        0xffff8c84,A3
...
000084d0             $C$RL1:
000084d0             $C$L3:
000084d0   01c64028           MVK.S1        0xffff8c80,A3
...
000084f0             $C$RL2:
000084f0             $C$L4:
000084f0   10006812           CALLP.S2      abort (PC+832 = 0x00008820),B3
...
00008524   02c6502a ||        MVK.S2        0xffff8ca0,B5
...
00008540   02465629 ||        MVK.S1        0xffff8cac,A4
...
00008680   07c63e2a           MVK.S2        0xffff8c7c,B15
00008684   0780006a           MVKH.S2       0x0000,B15
00008688   07bf09f2           AND.D2        -8,B15,B15
0000868c   0700042a           MVK.S2        0x0008,B14
...
000086b4             $C$RL0:
000086b4   01c3f028           MVK.S1        0xffff87e0,A3
...
00008700             add:
00008700             .text:
00008700   07bf005a           SUB.L2        B15,0x8,B15
00008704       dc45           STW.D2T2      B4,*B15[2]
00008706       81ef           BNOP.S2       B3,4
00008708       cc3d ||        LDW.D2T1      *B15[2],A3
0000870a       ac45           STW.D2T1      A4,*B15[1]
0000870c   07bd005b ||        ADD.L2        8,B15,B15
00008710   02106078 ||        ADD.L1        A3,A4,A4
00008714             mul:
00008714   07bf005a           SUB.L2        B15,0x8,B15
00008718       dc45           STW.D2T2      B4,*B15[2]
0000871a       cc3d           LDW.D2T1      *B15[2],A3
0000871c   e8c00028           .fphead       n, l, W, BU, nobr, nosat, 1000110b
00008720       9247           MV.L2X        A4,B4
00008722       ac45           STW.D2T1      A4,*B15[1]
00008724   008c2362           BNOP.S2       B3,1
00008728   02107800           MPY32.M1X     A3,B4,A4
0000872c   07bd005a           ADD.L2        8,B15,B15
00008730   00002000           NOP           2
00008734             main:
00008734   02c38a2a           MVK.S2        0xffff8714,B5
00008738   01c38029           MVK.S1        0xffff8700,A3
0000873c   e0200000           .fphead       n, l, W, BU, nobr, nosat, 0000001b
00008740   0280006b ||        MVKH.S2       0x0000,B5
00008744   001098fb ||        CMPGT.L2X     B4,A4,B0
00008748   01bc94f6 ||        STW.D2T2      B3,*B15--[4]
0000874c   01800069           MVKH.S1       0x0000,A3
00008750   3280007e || [!B0]  STW.D2T2      B5,*+B14[0]
00008754   2180007c    [ B0]  STW.D2T1      A3,*+B14[0]
00008758   0280006e           LDW.D2T2      *+B14[0],B5
0000875c   023c42f6           STW.D2T2      B4,*+B15[2]
00008760       ac45           STW.D2T1      A4,*B15[1]
00008762       2c6e           NOP           2
00008764   00140362           B.S2          B5
00008768   01838162           ADDKPC.S2     $C$RL0 (PC+12 = 0x0000876c),B3,4
0000876c             $C$RL0:
0000876c   023c62f4           STW.D2T1      A4,*+B15[3]
00008770   01bc92e6           LDW.D2T2      *++B15[4],B3
00008774       0626           MVK.L1        0,A4
00008776       4c6e           NOP           3
00008778   008ca362           BNOP.S2       B3,5
0000877c   e4200000           .fphead       n, l, W, BU, nobr, nosat, 0100001b
00008780             __TI_cpp_init:
00008780             .text:__TI_cpp_init:
00008780       36f7           STW.D2T2      B13,*B15--[2]
00008782       a5c7 ||        MV.L2         B3,B13
00008784   01800028 ||        MVK.S1        0x0000,A3
00008788   01800069           MVKH.S1       0x0000,A3
0000878c   0500002b ||        MVK.S2        0x0000,B10
00008790   053c35c6 ||        STDW.D2T2     B11:B10,*B15--[1]
00008794   0500006a           MVKH.S2       0x0000,B10
00008798   058c1fda           MV.L2X        A3,B11
0000879c   e0200003           .fphead       n, l, W, BU, nobr, nosat, 0000001b
000087a0   00287a78           CMPEQ.L1X     A3,B10,A0
000087a4   d22836e7    [!A0]  LDW.D2T2      *B10++[1],B4
000087a8       a4aa || [ A0]  BNOP.S1       $C$L2 (PC+36 = 0x000087c4),5
000087aa       026f           BNOP.S2       B4,0
000087ac             $C$L1:
000087ac   01848162           ADDKPC.S2     $C$RL0 (PC+16 = 0x000087b0),B3,4
000087b0             $C$RL0:
000087b0   002d4a7a           CMPEQ.L2      B10,B11,B0
000087b4   30068121    [!B0]  BNOP.S1       $C$L1 (PC+12 = 0x000087ac),4
000087b8   322836e6 || [!B0]  LDW.D2T2      *B10++[1],B4
000087bc   e0808000           .fphead       n, l, W, BU, br, nosat, 0000100b
000087c0   30100362    [!B0]  B.S2          B4
000087c4             $C$L2:
000087c4   01b40fda           MV.L2         B13,B3
000087c8   000c0363           B.S2          B3
000087cc   053c33e6 ||        LDDW.D2T2     *++B15[1],B11:B10
000087d0   06bc52e6           LDW.D2T2      *++B15[2],B13
000087d4   00006000           NOP           4
000087d8   00000000           NOP           
000087dc   00000000           NOP           
000087e0             _args_main:
000087e0             .text:_args_main:
000087e0   02ffffa8           MVK.S1        0xffffffff,A5
000087e4   02ffffe9           MVKH.S1       0xffff0000,A5
000087e8   02c39a2a ||        MVK.S2        0xffff8734,B5
000087ec   0280006b           MVKH.S2       0x0000,B5
000087f0       fe27 ||        MVK.L2        -1,B4
000087f2       96e9           CMPEQ.L2X     B4,A5,B0
000087f4       62c6 ||        MV.L1         A5,A3
000087f6       02ef ||        BNOP.S2       B5,0
000087f8   320c0265    [!B0]  LDW.D1T1      *+A3[0],A4
000087fc   e6000600           .fphead       n, l, W, BU, nobr, nosat, 0110000b
00008800   0200a358 ||        MVK.L1        0,A4
00008804   0180a358           MVK.L1        0,A3
00008808   31948058    [!B0]  ADD.L1        4,A5,A3
0000880c   00000000           NOP           
00008810   020c1fda           MV.L2X        A3,B4
...
00008824             $C$L1:
00008824   0001a120           BNOP.S1       $C$L1 (PC+4 = 0x00008824),5
...
00008840             .text:decompress:none:__TI_decompress_none:
00008840   02906059           ADD.L1        3,A4,A5
00008844   0fffb410 ||        B.S1          memcpy (PC-608 = 0x000085e0)
00008848   03140264           LDW.D1T1      *+A5[0],A6
0000884c   0190e058           ADD.L1        7,A4,A3
00008850   02101fd8           MV.L1X        B4,A4
00008854   020c1fda           MV.L2X        A3,B4
00008858   00000000           NOP           
0000885c   00000000           NOP           
00008860             __TI_decompress_rle24:
00008860             .text:decompress:rle24:__TI_decompress_rle24:
00008860   010c1fd9           MV.L1X        B3,A2
00008864   1ffef413 ||        CALLP.S2      __TI_decompress_rle_core (PC-2144 = 0x00008000),B3
00008868   030000a8 ||        MVK.S1        0x0001,A6
0000886c   0088b362           BNOP.S2X      A2,5
