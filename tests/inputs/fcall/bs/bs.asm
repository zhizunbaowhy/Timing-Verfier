...
00008380             main:
00008380             .text:
00008380       31f7           STW.D2T2      B3,*B15--[2]
00008382       0e26           MVK.L1        8,A4
00008384   10000212 ||        CALLP.S2      binary_search (PC+16 = 0x00008390),B3
00008388             $C$RL0:
00008388       71f7           LDW.D2T2      *++B15[2],B3
0000838a       0626           MVK.L1        0,A4
0000838c       4c6e           NOP           3
0000838e       a1ef           BNOP.S2       B3,5
00008390             binary_search:
00008390       ccf7           SUBAW.D2      B15,0x6,B15
00008392       ac45           STW.D2T1      A4,*B15[1]
00008394       05a6           MVK.L1        0,A3
00008396       acb5           STW.D2T1      A3,*B15[5]
00008398       ce27           MVK.L2        14,B4
0000839a       9cc5           STW.D2T2      B4,*B15[4]
0000839c   efa00002           .fphead       n, l, W, BU, nobr, nosat, 1111101b
000083a0       fe27           MVK.L2        -1,B4
000083a2       dc45           STW.D2T2      B4,*B15[2]
000083a4       9ccd           LDW.D2T2      *B15[4],B4
000083a6       b1c7           MV.L2X        A3,B5
000083a8       4c6e           NOP           3
000083aa       9d89           CMPLT.L2X     B4,A3,B0
000083ac   204aa120    [ B0]  BNOP.S1       $C$DW$L$binary_search$7$E (PC+148 = 0x00008434),5
000083b0             $C$L1:
000083b0             $C$DW$L$binary_search$2$B:
000083b0       82c7           MV.L2         B5,B4
000083b2       9cdd ||        LDW.D2T2      *B15[4],B5
000083b4       6c6e           NOP           4
000083b6       a241           ADD.L2        B5,B4,B4
000083b8       2623           SHR.S2        B4,0x1,B4
000083ba       fc45           STW.D2T2      B4,*B15[3]
000083bc   eee00100           .fphead       n, l, W, BU, nobr, nosat, 1110111b
000083c0   02c6002a           MVK.S2        0xffff8c00,B5
000083c4   0280006a           MVKH.S2       0x0000,B5
000083c8   02149e42           ADDAD.D2      B5,B4,B4
000083cc   021002e6           LDW.D2T2      *+B4[0],B4
000083d0   00109a7a           CMPEQ.L2X     B4,A4,B0
000083d4   301aa120    [!B0]  BNOP.S1       $C$DW$L$binary_search$3$E (PC+52 = 0x000083f4),5
000083d8             $C$DW$L$binary_search$2$E:
000083d8             $C$DW$L$binary_search$3$B:
000083d8       bccd           LDW.D2T2      *B15[5],B4
000083da       ee41           ADD.L2        B4,-1,B4
000083dc   e8150000           .fphead       p, l, DW/NDW, B, nobr, nosat, 1000000b
000083e0       9cc5           STW.D2T2      B4,*B15[4]
000083e2       fc4d           LDW.D2T2      *B15[3],B4
000083e4       86d1           ADD.L2        B5,4,B5
000083e6       4c6e           NOP           3
000083e8   02149e42           ADDAD.D2      B5,B4,B4
000083ec       104d           LDW.D2T2      *B4[0],B4
000083ee       6c6e           NOP           4
000083f0       dc45           STW.D2T2      B4,*B15[2]
000083f2       a90a           BNOP.S1       $C$DW$L$binary_search$6$E (PC+72 = 0x00008428),5
000083f4             $C$DW$L$binary_search$3$E:
000083f4             $C$L2:
000083f4             $C$DW$L$binary_search$4$B:
000083f4   02bc62e6           LDW.D2T2      *+B15[3],B5
000083f8   0346002a           MVK.S2        0xffff8c00,B6
000083fc   e3608000           .fphead       n, l, W, BU, br, nosat, 0011011b
00008400   0300006a           MVKH.S2       0x0000,B6
00008404   00002000           NOP           2
00008408   0298be42           ADDAD.D2      B6,B5,B5
0000840c       10dd           LDW.D2T2      *B5[0],B5
0000840e       be29           CMPGT.L2X     B5,A4,B0
00008410   3010a120    [!B0]  BNOP.S1       $C$DW$L$binary_search$5$E (PC+32 = 0x00008420),5
00008414             $C$DW$L$binary_search$4$E:
00008414             $C$DW$L$binary_search$5$B:
00008414       fc4d           LDW.D2T2      *B15[3],B4
00008416       ee41           ADD.L2        B4,-1,B4
00008418       9cc5           STW.D2T2      B4,*B15[4]
0000841a       a50a           BNOP.S1       $C$DW$L$binary_search$6$E (PC+40 = 0x00008428),5
0000841c   ed108000           .fphead       p, l, W, BU, br, nosat, 1101000b
00008420             $C$DW$L$binary_search$5$E:
00008420             $C$L3:
00008420             $C$DW$L$binary_search$6$B:
00008420       fc4d           LDW.D2T2      *B15[3],B4
00008422       6c6e           NOP           4
00008424       2641           ADD.L2        B4,1,B4
00008426       bcc5           STW.D2T2      B4,*B15[5]
00008428             $C$DW$L$binary_search$6$E:
00008428             $C$L4:
00008428             $C$DW$L$binary_search$7$B:
00008428       9ccd           LDW.D2T2      *B15[4],B4
0000842a       bcdd           LDW.D2T2      *B15[5],B5
0000842c       6c6e           NOP           4
0000842e       ae29           CMPGT.L2      B5,B4,B0
00008430   3fc8a120    [!B0]  BNOP.S1       $C$L1 (PC-112 = 0x000083b0),5
00008434             $C$DW$L$binary_search$7$E:
00008434             $C$L5:
00008434       cc4d           LDW.D2T1      *B15[2],A4
00008436       6c6e           NOP           4
00008438   07800c52           ADDK.S2       24,B15
0000843c   e5e00000           .fphead       n, l, W, BU, nobr, nosat, 0101111b
00008440   008ca362           BNOP.S2       B3,5
