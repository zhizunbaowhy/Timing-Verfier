...
00008620             fib:
00008620             .text:
00008620       ccf7           SUBAW.D2      B15,0x6,B15
00008622       ac45           STW.D2T1      A4,*B15[1]
00008624       25a6           MVK.L1        1,A3
00008626       ec35           STW.D2T1      A3,*B15[3]
00008628       05a6           MVK.L1        0,A3
0000862a       8cb5           STW.D2T1      A3,*B15[4]
0000862c       4627           MVK.L2        2,B4
0000862e       dc45           STW.D2T2      B4,*B15[2]
00008630       c247           MV.L2         B4,B6
00008632       db93 ||        MVK.S2        30,B7
00008634   009cc8fa           CMPGT.L2      B6,B7,B1
00008638   40288120    [ B1]  BNOP.S1       $C$DW$L$fib$4$E (PC+80 = 0x00008670),4
0000863c   e3e00100           .fphead       n, l, W, BU, nobr, nosat, 0011111b
00008640   001098fa           CMPGT.L2X     B4,A4,B0
00008644   2018a120    [ B0]  BNOP.S1       $C$DW$L$fib$4$E (PC+48 = 0x00008670),5
00008648             $C$L1:
00008648             $C$DW$L$fib$3$B:
00008648       fc4d           LDW.D2T2      *B15[3],B4
0000864a       bcc5           STW.D2T2      B4,*B15[5]
0000864c       9cdd           LDW.D2T2      *B15[4],B5
0000864e       a241           ADD.L2        B5,B4,B4
00008650       fc45           STW.D2T2      B4,*B15[3]
00008652       bccd           LDW.D2T2      *B15[5],B4
00008654       9cc5           STW.D2T2      B4,*B15[4]
00008656       dc4d           LDW.D2T2      *B15[2],B4
00008658       2641           ADD.L2        B4,1,B4
0000865a       dc45           STW.D2T2      B4,*B15[2]
0000865c   ef900000           .fphead       p, l, W, BU, nobr, nosat, 1111100b
00008660   001c88fa           CMPGT.L2      B4,B7,B0
00008664   20088120    [ B0]  BNOP.S1       $C$DW$L$fib$4$E (PC+16 = 0x00008670),4
00008668       a247           MV.L2         B4,B5
0000866a             $C$DW$L$fib$3$E:
0000866a             $C$DW$L$fib$4$B:
0000866a       be29           CMPGT.L2X     B5,A4,B0
0000866c   3ff4a120    [!B0]  BNOP.S1       $C$L1 (PC-24 = 0x00008648),5
00008670             $C$DW$L$fib$4$E:
00008670             $C$L2:
00008670       fc4d           LDW.D2T2      *B15[3],B4
00008672       6c6e           NOP           4
00008674       dcc5           STW.D2T2      B4,*B15[6]
00008676       9246           MV.L1X        B4,A4
00008678   07800c52           ADDK.S2       24,B15
0000867c   e6800000           .fphead       n, l, W, BU, nobr, nosat, 0110100b
00008680   008ca362           BNOP.S2       B3,5
00008684             main:
00008684       31f7           STW.D2T2      B3,*B15--[2]
00008686       da13           MVK.S2        30,B4
00008688       bc45           STW.D2T2      B4,*B15[1]
0000868a       9246           MV.L1X        B4,A4
0000868c   1ffff412 ||        CALLP.S2      fib (PC-96 = 0x00008620),B3
00008690             $C$RL0:
00008690       ac4d           LDW.D2T1      *B15[1],A4
00008692       6c6e           NOP           4
00008694       71f7           LDW.D2T2      *++B15[2],B3
00008696       6c6e           NOP           4
00008698   008ca362           BNOP.S2       B3,5
0000869c   e6c00020           .fphead       n, l, W, BU, nobr, nosat, 0110110b
...
00008708   02c3422a ||        MVK.S2        0xffff8684,B5
