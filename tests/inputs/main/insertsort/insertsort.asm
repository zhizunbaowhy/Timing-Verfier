...
00008198   c34a9628 || [ A0]  MVK.S1        0xffff952c,A6
0000819c   e1400088           .fphead       n, l, W, BU, nobr, nosat, 0001010b
000081a0   d0001c11    [!A0]  B.S1          copy_in (PC+224 = 0x00008280)
000081a4   c24aa22a || [ A0]  MVK.S2        0xffff9544,B4
000081a8   c2ca902b    [ A0]  MVK.S2        0xffff9520,B5
000081ac   c1ca9a28 || [ A0]  MVK.S1        0xffff9534,A3
...
000081c4             $C$RL0:
000081c4   034a9629           MVK.S1        0xffff952c,A6
000081c8   02ca902a ||        MVK.S2        0xffff9520,B5
000081cc   01ca9a29           MVK.S1        0xffff9534,A3
000081d0   024aa22a ||        MVK.S2        0xffff9544,B4
...
000082b8   92ca9029    [!A1]  MVK.S1        0xffff9520,A5
...
000082e4   834a9028 || [ A1]  MVK.S1        0xffff9520,A6
...
00008380             main:
00008380             .text:
00008380       8cf7           SUBAW.D2      B15,0x4,B15
00008382       0627           MVK.L2        0,B4
00008384   023c22f6           STW.D2T2      B4,*+B15[1]
00008388   0282002a           MVK.S2        0x0400,B5
0000838c   00148afa           CMPLT.L2      B4,B5,B0
00008390   301ca120    [!B0]  BNOP.S1       $C$DW$L$main$2$E (PC+56 = 0x000083b8),5
00008394             $C$L1:
00008394             $C$DW$L$main$2$B:
00008394   02c4802b           MVK.S2        0xffff8900,B5
00008398   01820028 ||        MVK.S1        0x0400,A3
0000839c   e0200000           .fphead       n, l, W, BU, nobr, nosat, 0000001b
000083a0   0280006b           MVKH.S2       0x0000,B5
000083a4       7a30 ||        SUB.L1X       A3,B4,A3
000083a6       86b5           STH.D2T1      A3,*B5[B4]
000083a8       bc4d           LDW.D2T2      *B15[1],B4
000083aa       6c6e           NOP           4
000083ac       2641           ADD.L2        B4,1,B4
000083ae       bc45           STW.D2T2      B4,*B15[1]
000083b0   01820028           MVK.S1        0x0400,A3
000083b4       7e28           CMPGT.L1X     A3,B4,A0
000083b6       beaa    [ A0]  BNOP.S1       $C$L1 (PC-12 = 0x00008394),5
000083b8             $C$DW$L$main$2$E:
000083b8             $C$L2:
000083b8       0627           MVK.L2        0,B4
000083ba       bc45           STW.D2T2      B4,*B15[1]
000083bc   edc28000           .fphead       n, l, W, HU, br, nosat, 1101110b
000083c0   0282002a           MVK.S2        0x0400,B5
000083c4   00148afa           CMPLT.L2      B4,B5,B0
000083c8   3056a120    [!B0]  BNOP.S1       $C$DW$L$main$7$E (PC+172 = 0x0000846c),5
000083cc             $C$L3:
000083cc             $C$DW$L$main$4$B:
000083cc       bc4d           LDW.D2T2      *B15[1],B4
000083ce       6c6e           NOP           4
000083d0       dc45           STW.D2T2      B4,*B15[2]
000083d2       ad8a           BNOP.S1       $C$DW$L$main$5$E (PC+108 = 0x0000842c),5
000083d4             $C$DW$L$main$4$E:
000083d4             $C$L4:
000083d4             $C$DW$L$main$5$B:
000083d4       dc4d           LDW.D2T2      *B15[2],B4
000083d6       a347           MV.L2         B6,B5
000083d8       4c6e           NOP           3
000083da       96cd           LDH.D2T2      *B5[B4],B4
000083dc   ef038000           .fphead       n, l, W, H, br, nosat, 1111000b
000083e0   00006000           NOP           4
000083e4   023cc2d6           STH.D2T2      B4,*+B15[6]
000083e8   023c42e6           LDW.D2T2      *+B15[2],B4
000083ec   0fbc42e6           LDW.D2T2      *+B15[2],B31
000083f0       cfc7           MV.L2         B7,B30
000083f2       2c6e           NOP           2
000083f4       8241           ADD.L2        B4,B4,B4
000083f6       ce41           ADD.L2        B4,-2,B4
000083f8       a251           ADD.L2        B5,B4,B5
000083fa       12ed           LDH.D2T2      *B5[0],B6
000083fc   ee030000           .fphead       n, l, W, H, nobr, nosat, 1110000b
00008400   00006000           NOP           4
00008404   037bead6           STH.D2T2      B6,*+B30[B31]
00008408   023c42e6           LDW.D2T2      *+B15[2],B4
0000840c   02bcc2c6           LDH.D2T2      *+B15[6],B5
00008410       73c6           MV.L1X        B7,A3
00008412       2c6e           NOP           2
00008414       8241           ADD.L2        B4,B4,B4
00008416       ce41           ADD.L2        B4,-2,B4
00008418       0c6e           NOP           1
0000841a       7230           ADD.L1X       A3,B4,A3
0000841c   ee000000           .fphead       n, l, W, BU, nobr, nosat, 1110000b
00008420   028c0256           STH.D1T2      B5,*+A3[0]
00008424       dc4d           LDW.D2T2      *B15[2],B4
00008426       6c6e           NOP           4
00008428       ee41           ADD.L2        B4,-1,B4
0000842a       dc45           STW.D2T2      B4,*B15[2]
0000842c             $C$DW$L$main$5$E:
0000842c             $C$L5:
0000842c             $C$DW$L$main$6$B:
0000842c   03c4802a           MVK.S2        0xffff8900,B7
00008430   0380006b           MVKH.S2       0x0000,B7
00008434       a247 ||        MV.L2         B4,B5
00008436       8237 ||        ADD.D2        B4,B4,B4
00008438   0213c1a3           SUB.S2        B4,0x2,B4
0000843c   e4c00400           .fphead       n, l, W, BU, nobr, nosat, 0100110b
00008440       c3c7 ||        MV.L2         B7,B6
00008442       b74d           LDH.D2T2      *B6[B5],B4
00008444       e251 ||        ADD.L2        B7,B4,B5
00008446       12dd           LDH.D2T2      *B5[0],B5
00008448       6c6e           NOP           4
0000844a       8e89           CMPLT.L2      B4,B5,B0
0000844c   2fcaa120    [ B0]  BNOP.S1       $C$DW$L$main$4$E (PC-108 = 0x000083d4),5
00008450             $C$DW$L$main$6$E:
00008450             $C$DW$L$main$7$B:
00008450       bc4d           LDW.D2T2      *B15[1],B4
00008452       6c6e           NOP           4
00008454       2641           ADD.L2        B4,1,B4
00008456       bc45           STW.D2T2      B4,*B15[1]
00008458   0202002b           MVK.S2        0x0400,B4
0000845c   e6e30002           .fphead       n, l, W, H, nobr, nosat, 0110111b
00008460   02900fda ||        MV.L2         B4,B5
00008464   0010aafa           CMPLT.L2      B5,B4,B0
00008468   2fdba120    [ B0]  BNOP.S1       $C$L3 (PC-148 = 0x000083cc),5
0000846c             $C$DW$L$main$7$E:
0000846c             $C$L6:
0000846c   0204a358           MVK.L1        1,A4
00008470   07800852           ADDK.S2       16,B15
00008474   008ca362           BNOP.S2       B3,5
...
00008560             exit:
00008560             .text:exit:
00008560   01ca8429           MVK.S1        0xffff9508,A3
...
00008588   21ca8229    [ B0]  MVK.S1        0xffff9504,A3
...
000085ac             $C$RL0:
000085ac   01ca8228           MVK.S1        0xffff9504,A3
...
000085d0             $C$RL1:
000085d0             $C$L3:
000085d0   01ca8028           MVK.S1        0xffff9500,A3
...
00008624   02ca902a ||        MVK.S2        0xffff9520,B5
...
00008640   024a9629 ||        MVK.S1        0xffff952c,A4
...
00008780   07ca7e2a           MVK.S2        0xffff94fc,B15
...
00008868   02c1c02a ||        MVK.S2        0xffff8380,B5
